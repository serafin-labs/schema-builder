...
export interface JsonSchemaTypeInterface {
    type: "integer" | "number" | "string" | "boolean" | "object" | "array" | "null", properties?: any, items?: any, required?: string[], enum?: string[]
}
...
export type JsonSchema<T extends JsonSchemaTypeInterface> = T extends { type: infer TYPE, properties?: infer PROPERTIES, items?: infer ITEM, required?: Array<infer REQUIRED>, enum?: infer ENUM } ?
    ...
    number :
    TYPE extends "string" ?
    ENUM extends Array<infer ENUM_VALUE> ?
    ENUM_VALUE :
    string :
    ...
    TYPE extends "null" ?
    null :
    ITEM extends JsonSchemaTypeInterface ?
    JsonSchemaArray<ITEM> :
    REQUIRED extends keyof PROPERTIES ?
    JsonProperties<PROPERTIES, REQUIRED> :
    JsonProperties<PROPERTIES, null> :
    any

/**
 * /!\ Experimental
 * Intermediate interface for "parsing" inline json schemas
 * It avoids circular references
 */
export interface JsonSchemaArray<T extends JsonSchemaTypeInterface> extends Array<JsonSchema<T>> { }
...
export class SchemaBuilder<T> {
     ...
     * Type and enums has to be string literals for this function to work... So you'll probably have to use contants (ex: STRING_TYPE), cast string as themselves (ex: "boolean" as "boolean") or pass the schema itself as the generic type argument.
     * 
     * @param schema 
     */
