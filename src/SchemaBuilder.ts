...
export class SchemaBuilder<T> {
     ...
     * @param schemaBuilder 
     */
    addProperty<U, K extends keyof any>(propertyName: K, schemaBuilder: SchemaBuilder<U>): SchemaBuilder<{ [P in keyof Combine<T, U, K>]: Combine<T, U, K>[P] }> {
     ...
     * @param schemaBuilder 
     */
    addOptionalProperty<U, K extends keyof any>(propertyName: K, schemaBuilder: SchemaBuilder<U>): SchemaBuilder<{ [P in keyof CombineOptional<T, U, K>]: CombineOptional<T, U, K>[P] }> {
        if (!this.isObjectSchema) {
            throw new VError(`Schema Builder Error: you can only add properties to an object schema`);
        }
        this.schemaObject.properties = this.schemaObject.properties || {}
     ...
     * @param schema 
     */
    addString<K extends keyof any>(propertyName: K, schema: Pick<JSONSchema, JSONSchemaStringProperties> = {}): SchemaBuilder<{ [P in keyof Combine<T, string, K>]: Combine<T, string, K>[P] }> {
     ...
     * @param schema 
     */
    addOptionalString<K extends keyof any>(propertyName: K, schema: Pick<JSONSchema, JSONSchemaStringProperties> = {}): SchemaBuilder<{ [P in keyof CombineOptional<T, string, K>]: CombineOptional<T, string, K>[P] }> {
     ...
     * @param schema 
     */
    addEnum<K extends keyof any, K2 extends keyof any>(propertyName: K, values: K2[], schema: Pick<JSONSchema, JSONSchemaStringProperties> = {}): SchemaBuilder<{ [P in keyof Combine<T, K2, K>]: Combine<T, K2, K>[P] }> {
     ...
     * @param schema 
     */
    addOptionalEnum<K extends keyof any, K2 extends keyof any>(propertyName: K, values: K2[], schema: Pick<JSONSchema, JSONSchemaStringProperties> = {}): SchemaBuilder<{ [P in keyof CombineOptional<T, K2, K>]: CombineOptional<T, K2, K>[P] }> {
     ...
     * @param schema 
     */
    addNumber<K extends keyof any>(propertyName: K, schema: Pick<JSONSchema, JSONSchemaNumberProperties> = {}): SchemaBuilder<{ [P in keyof Combine<T, number, K>]: Combine<T, number, K>[P] }> {
     ...
     * @param schema 
     */
    addOptionalNumber<K extends keyof any>(propertyName: K, schema: Pick<JSONSchema, JSONSchemaNumberProperties> = {}): SchemaBuilder<{ [P in keyof CombineOptional<T, number, K>]: CombineOptional<T, number, K>[P] }> {
     ...
     * @param schema 
     */
    addInteger<K extends keyof any>(propertyName: K, schema: Pick<JSONSchema, JSONSchemaNumberProperties> = {}): SchemaBuilder<{ [P in keyof Combine<T, number, K>]: Combine<T, number, K>[P] }> {
     ...
     * @param schema 
     */
    addOptionalInteger<K extends keyof any>(propertyName: K, schema: Pick<JSONSchema, JSONSchemaNumberProperties> = {}): SchemaBuilder<{ [P in keyof CombineOptional<T, number, K>]: CombineOptional<T, number, K>[P] }> {
     ...
     * @param schema 
     */
    addBoolean<K extends keyof any>(propertyName: K, schema: Pick<JSONSchema, JSONSchemaProperties> = {}): SchemaBuilder<{ [P in keyof Combine<T, boolean, K>]: Combine<T, boolean, K>[P] }> {
     ...
     * @param schema 
     */
    addOptionalBoolean<K extends keyof any>(propertyName: K, schema: Pick<JSONSchema, JSONSchemaProperties> = {}): SchemaBuilder<{ [P in keyof CombineOptional<T, boolean, K>]: CombineOptional<T, boolean, K>[P] }> {
     ...
     * @param schema 
     */
    addArray<U extends {}, K extends keyof any>(propertyName: K, items: SchemaBuilder<U>, schema: Pick<JSONSchema, JSONSchemaArrayProperties> = {}): SchemaBuilder<{ [P in keyof Combine<T, U[], K>]: Combine<T, U[], K>[P] }> {
     ...
     * @param schema 
     */
    addOptionalArray<U extends {}, K extends keyof any>(propertyName: K, items: SchemaBuilder<U>, schema: Pick<JSONSchema, JSONSchemaArrayProperties> = {}): SchemaBuilder<{ [P in keyof CombineOptional<T, U[], K>]: CombineOptional<T, U[], K>[P] }> {
     ...
     * @param schema 
     */
    addStringArray<K extends keyof any>(propertyName: K, schema: Pick<JSONSchema, JSONSchemaArrayProperties> = {}): SchemaBuilder<{ [P in keyof Combine<T, string[], K>]: Combine<T, string[], K>[P] }> {
     ...
     * @param schema 
     */
    addOptionalStringArray<K extends keyof any>(propertyName: K, schema: Pick<JSONSchema, JSONSchemaArrayProperties> = {}): SchemaBuilder<{ [P in keyof CombineOptional<T, string[], K>]: CombineOptional<T, string[], K>[P] }> {
