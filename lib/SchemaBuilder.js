...
var SchemaBuilder = (function () {
    ...
    SchemaBuilder.prototype.addObject = function (propertyName, schemaBuilder) {
        return this.addProperty(propertyName, schemaBuilder);
    };
    SchemaBuilder.prototype.addOptionalObject = function (propertyName, schemaBuilder) {
        return this.addOptionalProperty(propertyName, schemaBuilder);
    };
    ...
    SchemaBuilder.prototype.pickAdditionalProperties = function (properties, additionalProperties) {
        ...
        var additionalProps = this.schemaObject.additionalProperties;
        ...
        if (additionalProperties === null) {
            ...
            for (var _i = 0, additionalProperties_1 = additionalProperties; _i < additionalProperties_1.length; _i++) {
                var additionalProperty = additionalProperties_1[_i];
    ...
    SchemaBuilder.prototype.overwriteProperties = function (schema) {
        ...
        var _loop_1 = function (propertyKey) {
            if (!(propertyKey in this_1.schemaObject.properties)) {
                this_1.schemaObject.properties[propertyKey] = schema.schemaObject.properties[propertyKey];
                if (schema.schemaObject.required && schema.schemaObject.required.indexOf(propertyKey) !== -1) {
                    this_1.schemaObject.required = this_1.schemaObject.required || [];
                    this_1.schemaObject.required.push(propertyKey);
                }
            }
            else {
                this_1.schemaObject.properties[propertyKey] = schema.schemaObject.properties[propertyKey];
                ...
                else if (this_1.schemaObject.required) {
                    this_1.schemaObject.required = this_1.schemaObject.required.filter(function (r) { return r !== propertyKey; });
                }
            }
        };
        var this_1 = this;
    ...
    SchemaBuilder.prototype.clone = function (schema) {
        if (schema === void 0) { schema = {}; }
        var schemaCopy = _.cloneDeep(this.schemaObject);
        for (var propertyName in schema) {
            schemaCopy[propertyName] = schema[propertyName];
        }
        return new SchemaBuilder(schemaCopy);
    };
